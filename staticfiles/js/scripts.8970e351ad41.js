$(document).ready(function () {
  ...
  tinymce.init({
    ...
    toolbar:
      "undo redo | fontsizeselect formatselect | bold italic underline strikethrough | link | align | checklist numlist bullist indent outdent | emoticons charmap | removeformat",
  });
